class GitopsSets:
    ...
    def open_dev_info_configmap_details(self):
        self.page.get_by_role("link", name="dev-info-configmap").click()

    def open_staging_info_configmap_details(self):
        self.page.get_by_role("link", name="staging-info-configmap").click()

    def open_production_info_configmap_details(self):
        self.page.get_by_role("link", name="production-info-configmap").click()
